...
module tb_binder();
    ...
    // instantiate binder
    binder #(.SHIFT(SHIFTS[0]))BINDER_0(
        .clk(clk),
        .nrst(nrst),
        .en(en),
    ...
    initial begin
        ...
        // Load the level hvs     
        $readmemb("C:/Users/User/Documents/Verilog Saves/sample_encoding/sample_encoding.srcs/sim_1/new/tb_binder_level_hvs.mem", level_hvs);
        $display(level_hvs);      
