...
module tb_encoding_top();
    ...
    wire encoding_done;
    wire [DIMS_PER_CC-1:0] encoded_hv_segment;
    ...
    encoding_top ENCODING_TOP(
        ...
        .encoded_hv_segment(encoded_hv_segment)   
    );   
    ...
    initial begin                    
        ...
        // Input 1
        $readmemb("C:/Users/User/Documents/Verilog Saves/sample_encoding_f40_dim64/sample_encoding.srcs/sim_1/new/tb_encoding_top_f40_dim80.mem", level_HVs);     
